...
version: "2026-05-07-upcoming-deprecation-of-gpt-4-1"
...
# github-copilot — Upcoming deprecation of GPT-4.1
...
<div class="BorderBottom">
	...
	May 7, 2026</time>			•
		1 minute read	</div>
		<h1 class="Heading--2">Upcoming deprecation of GPT-4.1</h1>
	</div>
...
<p>We will deprecate the following model across all GitHub Copilot experiences (including Copilot Chat, inline edits, ask and agent modes, and code completions) on 6/1/2026:</p>
