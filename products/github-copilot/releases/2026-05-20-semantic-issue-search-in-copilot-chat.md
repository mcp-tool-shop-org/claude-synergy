...
version: "2026-05-20-semantic-issue-search-in-copilot-chat"
...
# github-copilot — Semantic issue search in Copilot Chat
...
<div class="BorderBottom">
	...
	May 20, 2026</time>			•
		1 minute read	</div>
		<h1 class="Heading--2">Semantic issue search in Copilot Chat</h1>
	</div>
	
	<div class="ChangelogFeaturedImage">
					<svg aria-hidden="true" width="2400" height="1260" role="presentation"></svg>
			<img width="2064" height="1096" src="https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?resize=2064%2C1096" class="CoverImage wp-post-image" alt="Screenshot of Copilot Chat showing issues related to improving documentation in a repository using semantic issues search" decoding="async" fetchpriority="high" srcset="https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=300 300w, https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=1600 1600w, https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=800 800w, https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=400 400w, https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=1032 1032w, https://github.blog/wp-content/uploads/2026/05/592762626-082e2067-4234-4b66-a517-2e011e7f65b8.jpg?w=516 516w" sizes="(max-width: 2064px) 100vw, 2064px">				
	</div>
</header>
					</div>
	</div>
		...
		<ul class="TableOfContents TableOfContents-desktop">
					...
					<a href="#whats-new" class="TableOfContents-item" aria-current="location">
						...
						<span>What's new</span>
							...
							<li>
					<a href="#try-it-out-and-share-feedback" class="TableOfContents-item" aria-current="false">
						<span class="TableOfContents-marker"></span>
						<span>Try it out and share feedback</span>
					</a>
				</li>
					</ul>
...
<p>You can use natural language in GitHub Copilot Chat on web to quickly find, group, and analyze issues, with context-aware results powered by a new semantic issues index.</p>
...
<p>Instead of relying only on exact matches and manual filters, Copilot Chat can now understand the intent of your query and surface issues that are semantically related even when they are worded differently.</p>
<p>You can use this capability to help you find an issue in a repository using natural language when you don’t remember the exact title or keywords, or to quickly filter issues related to a specific platform or environment.</p>
<h2 id="try-it-out-and-share-feedback"><a class="heading-link" href="#try-it-out-and-share-feedback">Try it out and share feedback<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h2>
<p>Head to <a href="https://github.com/copilot/">Copilot Chat</a> to see how semantic issues search can help with planning, triaging, and discovery.</p>
<p>This feature is generally available to users on all Copilot plans. Join <a href="https://github.com/orgs/community/discussions/180689">the discussion</a>.</p>
	...
	<manage-more class="Tags--lg">
			...
			<a href="https://github.blog/changelog/2026/?label=projects-and-issues" class="Tag Tag--lg" data-analytics-click="Changelog, click tag link, text: projects &amp; issues; ref_location:post footer;">projects &amp; issues</a>
