...
version: "2026-05-14-team-level-copilot-usage-metrics-now-available-via-api"
...
# github-copilot — Team-level Copilot usage metrics now available via API
...
<div class="BorderBottom">
	...
	May 14, 2026</time>			•
		2 minute read	</div>
		<h1 class="Heading--2">Team-level Copilot usage metrics now available via API</h1>
	</div>
		...
		<ul class="TableOfContents TableOfContents-desktop">
					...
					<a href="#how-it-works" class="TableOfContents-item" aria-current="location">
						...
						<span>How it works</span>
							...
							<li>
					<a href="#who-can-use-this-feature" class="TableOfContents-item" aria-current="false">
						<span class="TableOfContents-marker"></span>
						<span>Who can use this feature</span>
					</a>
				</li>
							<li>
...
<p>Each row in the user-teams report represents a team membership for a given day, including the team’s enterprise or organization id, team slug, and the user’s ID and login. To produce team-level metrics, join the user-teams report to the per-user usage report on <code>user_id</code> and <code>day</code>, then aggregate.</p>
...
<h3 id="who-can-use-this-feature"><a class="heading-link" href="#who-can-use-this-feature">Who can use this feature<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h3>
...
<h3 id="key-benefits"><a class="heading-link" href="#key-benefits">Key benefits<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h3>
<ul>
...
<li>Teams with fewer than five Copilot-seated users are excluded from the user-teams report, though their members’ individual activity remains visible in the per-user usage report.</li>
<li>Users who belong to multiple teams will have their activity counted in each team’s aggregate, so team totals cannot be summed to reproduce an organization or enterprise total.</li>
