...
version: "2026-05-19-gemini-3-5-flash-is-generally-available-for-github-copilot"
released_at: "2026-05-19"
source_url: "https://github.blog/changelog/2026-05-19-gemini-3-5-flash-is-generally-available-for-github-copilot"
fetched_at: "2026-05-22"
title: "Gemini 3.5 Flash is generally available for GitHub Copilot"
---

# github-copilot — Gemini 3.5 Flash is generally available for GitHub Copilot
...
<div class="BorderBottom">
	...
	May 19, 2026</time>			•
		1 minute read	</div>
		<h1 class="Heading--2">Gemini 3.5 Flash is generally available for GitHub Copilot</h1>
	</div>
	
	<div class="ChangelogFeaturedImage">
					<svg aria-hidden="true" width="2064" height="600" role="presentation"></svg>
			<img width="2064" height="600" src="https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?resize=2064%2C600" class="CoverImage wp-post-image" alt="The Copilot model picker with a pull-down menu showing Gemini 3.5 Flash selected" decoding="async" fetchpriority="high" srcset="https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=2064 2064w, https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=300 300w, https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=768 768w, https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=1024 1024w, https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=1536 1536w, https://github.blog/wp-content/uploads/2026/05/593639054-d3cbfc73-b538-4d9b-92dd-016602e69869_57558a.png?w=2048 2048w" sizes="(max-width: 2064px) 100vw, 2064px">				
	</div>
</header>
					</div>
	</div>
	...
	<table-of-contents>
		...
		<ul class="TableOfContents TableOfContents-desktop">
							<li>
					<a href="#availability-in-github-copilot" class="TableOfContents-item" aria-current="location">
						<span class="TableOfContents-marker"></span>
						<span>Availability in GitHub Copilot</span>
					</a>
				</li>
							<li>
					<a href="#enabling-access" class="TableOfContents-item" aria-current="false">
						<span class="TableOfContents-marker"></span>
						<span>Enabling access</span>
					</a>
				</li>
							<li>
					<a href="#learn-more" class="TableOfContents-item" aria-current="false">
						<span class="TableOfContents-marker"></span>
		...
		<details class="TableOfContents-mobile" data-target="table-of-contents.details">
			<summary class="TableOfContents-summary">
				<div class="TableOfContents-summary-text"><span class="sr-only">Menu. Currently selected: </span><span data-target="table-of-contents.current-label">Availability in GitHub Copilot</span></div>
...
<p><strong>Gemini 3.5 Flash</strong>, Google’s latest Flash-tier model, is now rolling out on GitHub Copilot. In our early testing, Gemini 3.5 Flash delivers near-Pro coding quality at Flash-tier speed and cost with strong tool use, fast response times, and high cache efficiency that make it well-suited for fast, iterative agentic coding workflows.</p>
<p>Note, that while this model is launching with a 14X premium request multiplier, pricing is tentative and subject to change.</p>
<h3 id="availability-in-github-copilot"><a class="heading-link" href="#availability-in-github-copilot">Availability in GitHub Copilot<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h3>
<p>Gemini 3.5 Flash will be available to Copilot Pro, Copilot Pro+, Copilot Business, and Copilot Enterprise users.</p>
<p>You’ll be able to select the model in:</p>
<ul>
<li>Visual Studio Code in versions 1.115.0 or later</li>
<li>Visual Studio in versions 17.14.22 or 18.1.0 and later</li>
<li>JetBrains</li>
<li>Xcode</li>
<li>Eclipse</li>
</ul>
<p>Rollout will be gradual. Check back soon if you don’t see it yet.</p>
<h3 id="enabling-access"><a class="heading-link" href="#enabling-access">Enabling access<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h3>
<p>Copilot Enterprise and Copilot Business plan administrators must enable the Gemini 3.5 Flash policy in Copilot settings.</p>
...
<p>To explore all models available in GitHub Copilot, see our <a href="https://docs.github.com/copilot/reference/ai-models/supported-models">documentation on models</a> and get started with Copilot.</p>
<h3 id="share-your-feedback"><a class="heading-link" href="#share-your-feedback">Share your feedback<span class="heading-hash pl-2 text-italic text-bold" aria-hidden="true"></span></a></h3>
<p>Join the <a href="https://github.com/orgs/community/discussions/categories/copilot-conversations">GitHub Community</a> to share your feedback.</p>
