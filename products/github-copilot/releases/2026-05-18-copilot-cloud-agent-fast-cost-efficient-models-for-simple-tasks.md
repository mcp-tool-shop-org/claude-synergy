...
version: "2026-05-18-copilot-cloud-agent-fast-cost-efficient-models-for-simple-tasks"
...
# github-copilot — Copilot cloud agent: Fast, cost-efficient models for simple tasks
...
<div class="BorderBottom">
	...
	May 18, 2026</time>			•
		1 minute read	</div>
		<h1 class="Heading--2">Copilot cloud agent: Fast, cost-efficient models for simple tasks</h1>
	</div>
	
	<div class="ChangelogFeaturedImage">
					<svg aria-hidden="true" width="2400" height="1260" role="presentation"></svg>
			<img width="2064" height="1096" src="https://github.blog/wp-content/uploads/2026/05/image-5.jpg?resize=2064%2C1096" class="CoverImage wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=300 300w, https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=1600 1600w, https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=800 800w, https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=400 400w, https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=1032 1032w, https://github.blog/wp-content/uploads/2026/05/image-5.jpg?w=516 516w" sizes="(max-width: 2064px) 100vw, 2064px">				
	</div>
</header>
					</div>
	</div>
...
<p>When you delegate a task to <a href="https://docs.github.com/copilot/concepts/agents/cloud-agent/about-cloud-agent">Copilot cloud agent</a>, you can pick the model it uses to do its work.</p>
<p>Today, we’re expanding the list of supported models to include faster, more cost-efficient options. This means you can pick the right model for the job: a smaller, quicker model for straightforward changes, or a more capable model for complex work.</p>
<p>The following models are now available, in addition to the existing options:</p>
<ul>
<li>Claude Haiku 4.5 (0.33x multiplier)</li>
<li>GPT-5.4-mini (0.33x multiplier)</li>
</ul>
<p>To learn more, see <a href="https://docs.github.com/copilot/how-tos/use-copilot-agents/cloud-agent/changing-the-ai-model">“Changing the AI model for Copilot cloud agent”</a> in the GitHub Docs.</p>
