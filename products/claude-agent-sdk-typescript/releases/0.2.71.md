...
source_url: "https://github.com/anthropics/claude-agent-sdk-typescript/releases/tag/v0.2.71"
fetched_at: "2026-05-21"
claude_code_parity: "2.1.71"
---

# claude-agent-sdk-typescript v0.2.71
...
```sh
npm install @anthropic-ai/claude-agent-sdk@0.2.71
# or
